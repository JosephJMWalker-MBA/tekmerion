...
class FakeReminderRepository implements ReminderRepository {
  ...
  Future<List<ReminderInstance>> getForScheduleRule(
      ...
      [];
  @override
  Future<List<ReminderInstance>> getToday(DateTime now) async => today;
  @override
  Future<List<ReminderInstance>> getUpcoming(DateTime now) async => upcoming;
  @override
...
void main() {
  ...
  test('getTodayViewModels maps related data correctly', () async {
    ...
    agreementRepository.agreements.add(
      Agreement(
        id: 'a1',
    ...
    obligationRepository.obligations.add(
      Obligation(
        id: 'o1',
        agreementId: 'a1',
        sourceClauseId: 'c1',
    ...
    final viewModels =
        await service.getTodayViewModels(nowUtc, const Duration(days: 1));
